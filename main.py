...
class PdfRenamerApp:
    ...
    def __init__(self):
        ...
        # These are now relative paths, expecting folders at the project root.
        # Ensure these folders exist or are specified in your config/CLI.
        default_input_folder = "input_statements"
        default_processed_folder = "processed_statements"
